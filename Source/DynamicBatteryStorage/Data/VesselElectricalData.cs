  ...
  public class VesselElectricalData: VesselData
  {
    ...
    protected override void SetupDataHandler(PartModule pm)
    {
      if (Settings.IsSupportedPartModule(pm.moduleName, ResourcesSupported.Power))
      {
        ...
        string typeName = "DynamicBatteryStorage", "DynamicBatteryStorage." + data.handlerModuleName;
        ModuleDataHandler handler = (ModuleDataHandler) System.Activator.CreateInstance(typeName, data).Unwrap();
